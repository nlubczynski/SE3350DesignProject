...
public class LoginScreen extends Activity {
	...
	public void logIn() {
		...
		String userPassword = preferences.getString(usernameString,
				"NO_SUCH_USER");

		if (userPassword.equals("NO_SUCH_USER")
				|| !userPassword.equals(passwordString))
		...
		Intent openLoginScreen = new Intent(LoginScreen.this,
	...
	// Redirect Method
	/**
	 * This is a listenter class, but, we don't always want a listener so it
	 * just redirects to the typical log in class
	 * 
	 * @param view
	 */
	...
	public void saveUserDetails() {
		// Gets a shared preference called 'login' if it doesn't exist it will
		// create it
